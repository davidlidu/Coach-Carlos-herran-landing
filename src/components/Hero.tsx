        ...
        <div className="w-full md:w-3/5">
          ...
          <div>
            <a
              ...
              className="inline-flex items-center gap-3 px-8 py-4 rounded-xl bg-[#25D366] text-white font-semibold text-base hover:bg-[#1ebe5d] transition-all duration-200 shadow-lg shadow-[#25D366]/20"
            >
